    ...
    return (
        <>
            ...
            <section style={{ border: '' }} className="lagence-sec1">
                ...
                <section className="rectangular-oval-white-sec1" style={{ border: '3px solid red' }}>
                    <img className="lagence-sec1-img1-2" src="./images/Rectangle 9543-new.png" alt style={{ border: '' }} />
                </section>
